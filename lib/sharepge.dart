      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            child: FlexibleSpaceBar(titlePadding: const EdgeInsetsDirectional.only(
            start: 45.0, end: 15,bottom: 50.0),title:Text('keep seeking whatever matters to you'),
            collapseMode: CollapseMode.parallax,
            background: Image.asset('assets/Sharepage/images/bgpic.jpeg',fit: BoxFit.cover,))),
            expandedHeight: 270,
            elevation: 0,
